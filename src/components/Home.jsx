...
const Home = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 w-full">
      {matchesData.map(({ matchDetailsMap: { key: date, match } }, i) =>
        match.map(
          ({
            matchInfo: {
              team1: { teamSName: team1Name, imageId: image1Id },
              team2: { teamSName: team2Name, imageId: image2Id },
              status,
              matchId,
              matchDesc,
            },
            ...
            <Link to={`matchDetails/${matchId}`} className="w-full">
              {/* <h2>
                {team1Name} vs {team2Name}, {date} {status}
              </h2> */}
              <div className="p-3 border flex flex-col gap-3 h-[150px]">
                ...
                <div>
                  <div className="flex justify-between">
                    <div className="flex gap-5">
                      <img
                        ...
                        src={`https://res.cloudinary.com/digkgdovw/image/upload/v1715267650/iplTeamLogo/${image1Id}`}
                        alt=""
                      />
                      <p>{team1Name}</p>
                    </div>
                  ...
                  <div className="flex justify-between">
                    <div className="flex gap-5">
                      <img
                        className="w-4 object-contain"
                        src={`https://res.cloudinary.com/digkgdovw/image/upload/v1715267650/iplTeamLogo/${image2Id}`}
                        alt=""
                      />
                      <p>{team2Name}</p>
                    </div>
