...
function MatchDetails() {
  ...
  const [data, setMatcheData] = useState([]);
  let { id } = useParams();
  ...
  return (
    <>
      ...
      >
        {fixedData.matchInfo.team1.playerDetails.map((fixedData,i) => (
          <div key={i} className="text-xl m-5">
            <h1>{fixedData.fullName}</h1>
            <h2 className="opacity-50">{fixedData.role}</h2>
          </div>
        ))}
        {fixedData.matchInfo.team2.playerDetails.map((fixedData,i) => (
